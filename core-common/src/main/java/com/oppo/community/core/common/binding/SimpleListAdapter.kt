...
package com.oppo.community.core.common.binding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BindingViewHolder<VB> =
        BindingViewHolder(ViewBindingUtil.inflateWithGeneric<VB>(this, parent)).apply {
            itemView.setOnClickListener {
                onItemClickListener?.onItemClick(getItem(bindingAdapterPosition), bindingAdapterPosition)
            }
            itemView.setOnLongClickListener {
                onItemLongClickListener?.onItemClick(getItem(bindingAdapterPosition), bindingAdapterPosition)
